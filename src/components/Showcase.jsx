        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          {isAdmin && (
            <button 
              ...
              className="border-2 border-dashed border-slate-300 hover:border-brand-500 rounded-3xl h-full min-h-[340px] flex flex-col items-center justify-center space-y-3 bg-white/50 text-slate-400 hover:text-brand-700 transition group p-6 outline-none focus:ring-2 focus:ring-brand-500"
            >
